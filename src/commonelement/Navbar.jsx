...
import channelimg from '../assets/LOGO.png';
import './Navbar.css';
...
function Navbar({ HandleSidebar, sidebar }) {
  ...
  return (
    <nav className='flex justify-between px-4 py-4 fixed top-0 right-0 left-0 z-30 bg-blue-900 text-white items-center shadow-md'>
      <div>
        <a href="https://www.youtube.com/@learntime2424" className={`flex items-center gap-4 ${sidebar ? 'sm:hidden' : ''} md:flex`}>
          ...
          <div className='text-2xl font-bold'>CODE-STAT</div>
        </a>
      </div>
      <div>
